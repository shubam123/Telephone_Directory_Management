...
public partial class tele_operator : System.Web.UI.Page
{
    ...
    protected void add_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("INSERT INTO users(fname,lname,sex,dept,address,tel_number,mob_number,email) VALUES( @fname, @lname, @sex, @dept, @address, @tel_number, @mob_number, @email)", con);
